...
javascript:(function () { 
    ...
    var words = [
            ...
            ['utilising', "Using"],
            ['webinar'],
            ['the disabled',"Use 'disabled people' not 'the disabled' as the collective term"],
            ['deaf to our pleas',"Common phrases that may associate impairments with negative things should be avoided, for example 'deaf to our pleas' or 'blind drunk'."],
            ['blind drunk',"Common phrases that may associate impairments with negative things should be avoided, for example 'deaf to our pleas' or 'blind drunk'."],
            ...
            ['mentally defective',"with a learning disability (singular) with learning disabilities (plural)"],
            ['retarded',"with a learning disability (singular) with learning disabilities (plural)"],
            ['subnormal',"with a learning disability (singular) with learning disabilities (plural)"],
            ['cripple',"disabled person"],
            ['spastic',"person with cerebral palsy"],
            ['able-bodied',"non-disabled"],
            ['mental patient',"person with a mental health condition"],
            ['deaf and dumb',"deaf, user of British sign language, person with a hearing impairment"],
            ['deaf mute',"deaf, user of British sign language, person with a hearing impairment"],
            ['the blind',"people with visual impairments; blind people; blind and partially sighted people"],
            ['an epileptic',"a person with / someone who has epilepsy"],
            ['a diabetic',"a person with / someone who has diabetes"],
            ['a depressive',"a person with / someone who has depression"],
            ['dwarf',"someone with restricted growth"],
            ['midget',"someone with restricted growth"],
